...
export const STUDENT_LINKS = [
  ...
  { to: '/student/documents', label: 'Documents', description: 'Upload required OJT documents' },
  ...
  { to: '/rankings', label: 'Rankings', description: 'View system-wide rankings' },
...
export const SUPERVISOR_LINKS = [
  ...
  { to: '/supervisor/activities', label: 'Activity Approvals', description: 'View & approve student activities' },
